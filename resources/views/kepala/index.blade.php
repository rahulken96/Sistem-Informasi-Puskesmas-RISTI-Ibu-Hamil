...
<head>
    ...
    <title>{{ getRoles(Auth::user()->role) }} | Dashboard</title>
                ...
                <div class="sidebar-content">
                    <div class="user">
                        ...
                        <div class="info">
                            <a data-toggle="collapse" href="#collapseExample" aria-expanded="true">
                                <span>
                                    {{ Auth::user()->nama }}
                                    <span class="user-level">{{ getRoles(Auth::user()->role )}}</span>
                                </span>
                            </a>
                    ...
                    <ul class="nav nav">
						<li class="nav-item active">
							<a class="collapse" href="{{ route('kepala.dashboard') }}" class="collapsed" aria-expanded="false">
								<i class="fas fa-home"></i>
								<p>Dashboard</p>
								<a class="collapse" href="{{ route('kepala.pasien') }}" class="collapsed" aria-expanded="false">
