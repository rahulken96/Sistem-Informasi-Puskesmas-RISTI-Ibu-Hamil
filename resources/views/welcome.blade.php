...
<head>
    ...
    <title>Puskesmas Lohbener Indramayu</title>
    <meta content="Tempat Layanan Kesehatan Masyarakat Daerah Lohbener" name="description">
    <meta content="Puskesmas Lohbener" name="keywords">
...
<body>
    ...
    <header id="header" class="header fixed-top">
        <div class="container-fluid container-xl d-flex align-items-center justify-content-between">
            ...
            <a href="/" class="logo d-flex align-items-center">
                <img src="{{ asset('assets/img/kesmas.png') }}" alt="">
                    ...
                    <div class="d-flex user-logged nav-item dropdown no-arrow">
                        <a href="#" role="button" id="dropdownMenuLink" data-bs-toggle="dropdown" aria-expanded="false">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="dropdownMenuLink" style="right: 0; left: auto;">
                                @if (Auth::user()->role)
                                <li>
                                    <a href="{{ route( Auth::user()->role . '.dashboard') }}" class="dropdown-item">Dashboard</a>
                                </li>
                                @endif
                                <li>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 d-flex flex-column justify-content-center">
                    <h1 data-aos="fade-up">Puskesmas Lohbener</h1>
                    <h2 data-aos="fade-up" data-aos-delay="400">Jl. By Pass, Lohbener, Kec. Lohbener, Kabupaten
                        Indramayu, Jawa Barat 45252</h2>
                ...
                <div class="col-lg-6 hero-img" data-aos="zoom-out" data-aos-delay="200">
                    <img src="assets/img/puskesmas.jpg" class="img-fluid" alt="">
                </div>
            </div>
        </div>
    ...
    <footer id="footer" class="footer">
                ...
                <div class="row gy-4">
                    <div class="col-lg-5 col-md-12 footer-info">
                        <a href="index.html" class="logo d-flex align-items-center">
                            <img src="assets/img/kesmas.png" alt="">
                            <span>Puskesmas Lohbener</span>
                        </a>
        ...
        <div class="container">
            ...
            <div class="credits">
                Designed by <a href="https://polindra.ac.id/">POLINDRA</a>
            </div>
        </div>
    </footer><!-- End Footer -->
