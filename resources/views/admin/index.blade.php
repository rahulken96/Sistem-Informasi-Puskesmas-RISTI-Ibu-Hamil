			...
			<div class="sidebar-wrapper scrollbar scrollbar-inner">
				<div class="sidebar-content">
					<div class="user">
						...
						<div class="info">
							<a data-toggle="collapse" href="{{ route('admin.dashboard') }}" aria-expanded="true">
								<span>
									Admin
					...
					<ul class="nav nav">
						<li class="nav-item active">
							<a data-toggle="collapse" href="index.html" class="collapsed" aria-expanded="false">
								<a class="collapse" href="{{ route('admin.data-pasien') }}" class="collapsed" aria-expanded="false">
					...
					<div class="page-inner py-5">
						<div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
							<div>
								...
								<h5 class="text-white op-7 mb-2">Hi Admin!</h5>
							</div>
